...
public class TestCase27 {
	...
	static Logger log = Logger.getLogger(TestCase27.class);
	
    @Given("Launch browser and navigate to application_20")
    public void Launch_browser_and_navigate_to_application_20() {
    ...
    public void Enter_valid_username_20(DataTable dataTable) throws IOException {
    ...
    public void Enter_valid_password_20(DataTable dataTable) throws IOException {
		List<Map<String,String>> credentials = dataTable.asMaps(String.class,String.class);
		for(Map<String,String> row : credentials)
		{
    ...
    @When("Click on login button_20")
    public void Click_on_login_button_20() {
		Login login = new Login(driver);
		login.verifyLoginButton();
		Assert.assertTrue(login.flag);
    }
    @Then("Add products to the cart_20")
    public void Add_products_to_the_cart_20() {
		Dashboard dashboard = new Dashboard(driver);
		dashboard.verifyAddToCart();
		Assert.assertTrue(dashboard.flag);
    }
    @Then("Click on cart button_20")
    public void Click_on_cart_button_20() throws IOException, InterruptedException {
		Dashboard dashboard = new Dashboard(driver);
		dashboard.verifyCartButton();
		Assert.assertTrue(dashboard.flag);
    }
    @Then("Click on checkout button_20")
    public void Click_on_checkout_button_20() {
    ...
    public void Enter_checkout_details_20(DataTable dataTable) {
		List<Map<String,String>> credentials = dataTable.asMaps(String.class,String.class);
		for(Map<String, String> row : credentials)
		{
    ...
    @When("Click on continue button_20")
    public void Click_on_continue_button_20() {
		Dashboard3 dashboard3 = new Dashboard3(driver);
		dashboard3.verifyContinueButton();
		Assert.assertTrue(dashboard3.flag);
    }
    @Then("Click on finish button")
    public void click_on_finish_button() throws SocketException {
    	Dashboard3 dashboard3 = new Dashboard3(driver);
