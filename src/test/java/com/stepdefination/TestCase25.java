...
public class TestCase25 {
	...
	static Logger log = Logger.getLogger(TestCase25.class);

    @Given("Launch browser and navigate to application_18")
    public void Launch_browser_and_navigate_to_application_18() {
    ...
    public void Enter_valid_username_18(DataTable dataTable) throws IOException {
    ...
    public void Enter_valid_password_18(DataTable dataTable) throws IOException {
		List<Map<String,String>> credentials = dataTable.asMaps(String.class,String.class);
		for(Map<String,String> row : credentials)
		{
    ...
    @When("Click on login button_18")
    public void Click_on_login_button_18() {
		Login login = new Login(driver);
		login.verifyLoginButton();
		Assert.assertTrue(login.flag);
    }
    @Then("Add products to the cart_18")
    public void Add_products_to_the_cart_18() throws IOException, InterruptedException {
    	Dashboard dashboard = new Dashboard(driver);
    	dashboard.verifyAddToCart();
    	Assert.assertTrue(dashboard.flag);
    }
    @Then("Click on cart button_18")
    public void Click_on_cart_button_18() throws IOException, InterruptedException {
    	Dashboard dashboard = new Dashboard(driver);
    	dashboard.verifyCartButton();
    	Assert.assertTrue(dashboard.flag);
    }
    @Then("Click on checkout button_18")
    public void Click_on_checkout_button_18() {
    ...
    public void Enter_checkout_details_18(DataTable dataTable) {
		List<Map<String,String>> credentials = dataTable.asMaps(String.class,String.class);
		for(Map<String, String> row : credentials)
		{
    ...
    public void Check_product_details_are_correct() throws IOException, InterruptedException {
    	Dashboard dashboard = new Dashboard(driver);
